@extend('admin.app',['title'=>'دسته بندی ها'])
@section('content')
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <p>شما در مجموع {{ $categories->total() }} کاربر دارید.</p>
                            </div>
                        </div>
            ...
            <div class="nk-block">
                <div class="nk-tb-list is-separate mb-3">
                    <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col tb-col-xl"><span class="sub-text">کاربر</span></div>
                    ...
                    <div class="nk-block-between-md g-3">
                        <div class="g">
                            <ul class="pagination justify-content-center justify-content-md-start">
                                ...
                                <!-- Pagination Elements -->
                                @foreach ($categories->getUrlRange(1, $users->lastPage()) as $page => $url)
                                ...
                                <li class="page-item"><a class="page-link" href="{{ $categories->nextPageUrl() }}">بعدی</a>
                                </li>
                                @else
                                ...
                                <div>
                                    <select class="form-select js-select2" data-search="on" data-dropdown="xs center">
                                        ...
                                        @for ($i = 1; $i <= $categories->lastPage(); $i++)
                                            <option value="page-{{ $i }}" {{ $i==$categories->currentPage() ? 'selected' : ''
                                                }}>
                                                {{ $i }}</option>
                                            @endfor
                                    </select>
