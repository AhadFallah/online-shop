@extends('admin.app', ['title' => 'محصولات موجود'])
@section('content')
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col"><span>فروشنده</span></div>
                                        <div class="nk-tb-col"><span>قیمت</span></div>
                                        <div class="nk-tb-col"><span>موجودی</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-sm">
                                            <span class="tb-product">
                                                <img src="{{ $product->coverPic[0]->path }}" alt="" class="thumb" />
                                                <span class="title">{{ $product->ptype->name . ' ' . $product->name
                                                    }}</span>
                                            </span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-sub">{{ $product->seller->name }}</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-lead">{{ $product->price }}</span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-sub">{{ $product->number }}</span>
                                        </div>
                                        <div class="nk-tb-col tb-col-md">
                                            <span class="tb-sub">{{ $product->ptype->category->name }}</span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1 my-n1">
                                                <li class="me-n1">
                                            ...
                                            <div>
                                                <select class="form-select js-select2" data-search="on"
                                                    ...
                                                    @for ($i = 1; $i <= $products->lastPage(); $i++)
                                                        <option value="page-{{ $i }}" {{ $i==$products->currentPage() ?
                                                            'selected' : ''
                                                            }}>
                                                            {{ $i }}</option>
                                                        @endfor
