                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li>
                                                            <a href="#"><span>فعال شده</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><span>غیرفعال شده</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="#"><span>مسدود شده</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li>
                                                        <a href="#"><em
                                                                class="icon ni ni-shield-star"></em><span>بازنشانی رمز
                                                                عبور</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="#"><em
                        ...
                        <div class="nk-block-between-md g-3">
                            <div class="g">
                                <ul class="pagination justify-content-center justify-content-md-start">
                                    ...
                                    <li class="page-item"><a class="page-link"
                                            href="{{ $users->nextPageUrl() }}">بعدی</a></li>
                                    @else
