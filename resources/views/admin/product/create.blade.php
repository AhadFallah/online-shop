@extends('admin.app', ['title' => 'ایجاد محصول'])
@section('content')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">ایجاد محصول</h3>
                            </div>
                            ...
                            <form action="{{ route('products.store') }}" method="post">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group wrap">
                                            <textarea type="text" id="context" name="context" placeholder="کلید:مقدار" class="form-control no-resize">{{ old('context', $string) }}</textarea>
