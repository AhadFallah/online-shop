                                        ...
                                        <a class="chat-link" href="html/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">شما: لطفا اگه آخرین پیام های من رو دریافت
                                                        کردید، تایید کنید.</div>
                                    ...
                                    <li class="chat-item is-unread">
                                        <a class="chat-link" href="html/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">سلام، من ترنیان هستم، می تونید در حل این مشکل
                                                        به من کمک کنید؟</div>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="html/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">شما: من به تازگی یک کامپیوتر جدید خریدم اما
                                                        مشکلی دارم</div>
                                ...
                                <div class="nk-notification">
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text">شما درخواست <span>برداشت</span> کردید
                                            </div>
                                    ...
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text"><span>سفارش واریز</span> شما ثبت شد
                                            </div>
                                            <div class="nk-notification-time">2 ساعت پیش</div>
                                        </div>
                                    </div>
                        ...
                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-xl-block">
                                    <div class="user-status user-status-unverified">تایید نشده</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    ...
                                    <li>
                                        <a class="dark-switch" href="#"><em class="icon ni ni-moon"></em><span>حالت
                                                تاریک</span></a>
                                    </li>
                                </ul>
                            </div>
